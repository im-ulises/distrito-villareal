      ...
      <section className="masterplan" id="masterplan">
        ...
        <div className="shell masterplan__grid">
          <div className="masterplan__copy">
            ...
            <ButtonLink href="/images/masterplan-v5.webp" variant="ghost">Ver plano completo</ButtonLink>
          </div>
          <figure className="masterplan__media">
            <img src="/images/masterplan-v5.webp" alt="Planta arquitectónica de Distrito Villarreal" loading="lazy" />
            <figcaption>
